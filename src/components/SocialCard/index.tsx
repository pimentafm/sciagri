      ...
      <SimpleGrid flex="1" gap="4" minChildWidth="320px" align="flex-start">
        ...
        >
          ...
          <Text
            ...
            px={3}
          >
            Fernando Martins Pimenta é pesquisador associado ao Grupo de
            Pesquisa em Interação Atmosfera Biosfera - UFV. Suas áreas de
            atuação envolvem geoprocessamento, sensoriamento remoto, computação
            paralela e de alta performance e automação de análises geoespaciais.
            Possui formação em Engenharia de Agrimensura e Cartografia pela
            Universidade Federal de Viçosa (UFV), MG, Brasil e Engenharia de
            Biossistemas pela Universidade Federal de São João del-Rei (UFSJ),
            MG, Brasil. Atualmente é estudante de pós-graduação no MBA em Data
            Science & Analysis na Escola Superior de Agricultura Luiz de Queiroz
            na Universidade de São Paulo (USP/ESALQ), São Paulo, Brazil.
          </Text>
          ...
          <Stack align={"center"} justify={"center"} direction={"row"} mt={6}>
            ...
            >
              <IconButton
                ...
                icon={
                  <Icon as={FaResearchgate} w={8} h={8} color="green.400" />
                }
              />
            </NextLink>
